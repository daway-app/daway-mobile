...
/// (مواعيدي، أدويتي) — keeps the tab reachable and consistent (AppBar +
/// side menu) instead of just omitting it.
class ComingSoonTabScreen extends StatelessWidget {
  final String title;
  final IconData icon;

  const ComingSoonTabScreen({super.key, required this.title, required this.icon});
