        ...
        child: BlocConsumer<PatientProfileCubit, PatientProfileState>(
          ...
          builder: (context, state) {
            return switch (state) {
              ...
              PatientProfileLoadFailure(:final message) => _LoadError(message: message),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'بياناتك غير مكتملة، يرجى تعديل حسابك لإكمالها',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppCustomButton(
              text: 'إعادة المحاولة',
              onPressed: () => context.read<PatientProfileCubit>().load(),
            ),
          ],
        ),
      ),
